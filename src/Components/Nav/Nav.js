...
import {keepUser, setUser} from "../../ducks/reducer"
  ...
  render() {
    return (
            <div className= "Nav">
              ...
              <h3 className="Nav_links">New Post</h3>
              </Link>
              <div onclick={()=> this.logout} className="logout_button">
              <Link to = "/">
              ...
              <h3 className="Nav_links">Logout</h3>
              </Link>
              </div>
            </div>
    )
